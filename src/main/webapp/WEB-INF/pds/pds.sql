...
create table pds (
	...
	fName 	 varchar(200) not null,  /*  업로드시 파일의 이름  */ 
	fSName 	 varchar(200) not null,  /*  실제 파일 서버에 저장된 파일의 이름  */ 
	...
	hostIP varchar(50) not null, 		 /*  업로드시 클라이언트의 주소  */
	primary key (idx) 							 /*  기본키 : 자료실의 고유 번호  */
);